...
public class Configurar_obsequio extends JDialog implements ActionListener {
	...
	public Configurar_obsequio() {
		...
		}
		{
			...
			btnCancelar.setBounds(335, 46, 89, 23);
